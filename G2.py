...
# print(ex_tuple)
# my_tuple = (123,456,67.89,'Python') #mixed tuple
# print(my_tuple)
# empty_tuple = ()
# print(empty_tuple)
...
# List is Mutable
# example_list[4]='Python'
# print(example_list)
# Tuple is Immutable
# example_tuple[4]='Python'
# example_tuple = ('jaswanth','aatreyee','samyuktha','surya','Python')
# print(example_tuple)
...
# print(ex_dict)
# my_dict = {'name':'Python','age':45} #dict with string keys
# print(my_dict)
...
# Python program to find how many litres of petrol
...
# Python program to calculate the area of a square given the length of one side.
# length_of_side = 10
