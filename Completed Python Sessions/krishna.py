...
#string list
# my_list = ['sachin','virat','dhoni']
# print(my_list)
# # string tuple
# my_tuple = ('sachin','virat','dhoni')
# print(my_tuple)
#
# # mixed datatype list
# my_list = [123,45.67,'Krishna']
# print(my_list)
# my_tuple = (123,45.67,'Krishna')
# print(my_tuple)
#
# # Nested List
# nested_list = [12,34,'Krish',[50,49,48]]
# print(nested_list)
# # nested_tuple
# nested_tuple = (12,34,'Krish',(50,49,48))
# print(nested_tuple)

# Accessing elements in a list and tuple
# my_list = [123,45.67,'Krishna']
# #           0   1     2
# print(my_list)
# print(my_list[0])
...
# print(my_list[-1])
#
# my_tuple = (638,93.6,'Completed Python Sessions')
# print(my_tuple)
# print(my_tuple[0])
# print(my_tuple[1])
# print(my_tuple[-1])
...
#
# my_dict = {'name':'Krishna','class':'Completed Python Sessions'}
# print(my_dict)
# print(my_dict['name']) #accessing a dictionary

# my_list = []
# name = 'Krishna'
# age = 15
# subject = 'Completed Python Sessions'
#
# my_list.append(name)
# my_list.append(age)
...
# 1 int           1.0 float
# 1.56 float      1 int
# '34' str        34 int      34.0 float
# '56.8' str      56 int      56.8 float
...
# y = 15.5
# print(type(y))
# z = 'Completed Python Sessions'
# print(type(z))
#
# int_input = int(input('Enter int Data: '))
# print(int_input)
# print(type(int_input))
#
# float_input = float(input('Enter float data: '))
# print(float_input)
# print(type(float_input))
#
# str_input = input('Enter string data: ')
# print(str_input)
...
# Completed Python Sessions program to generate full name
