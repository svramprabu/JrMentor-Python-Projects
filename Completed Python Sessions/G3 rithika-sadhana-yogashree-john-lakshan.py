...
# file = open('g3.txt')
# file = open('g3.txt','w')
# file.write("Hi from Completed Python Sessions G3 ")
# file.close()
# file = open('g3.txt','a')
...
# import re
# s = "we are learning Completed Python Sessions"
# res = re.search('Py',s)
# print(res.start())
# print(res.end())
...
# import re
# s = "Hi my name is blah from Madurai"
# res = re.split('blah',s)
# print(res)
...
#     owner = 'Anonymous'
#     def ageFunc(self):
#         print(f'House owned by {self.owner}')
#
# ageVar = myage()
# ageVar.ageFunc()
# ageVar.owner = 'Ramprabu'
# print(ageVar.owner)
# ageVar.ageFunc()


# class myage:
#     def ageFunc(self,O='Anonymous'):
#         self.owner = O
#         print(f'House owned by {self.owner}')
#
# ageVar = myage()
...
# class House:
#     def __init__(self,owner='Anonymous'): #constructor function
#         self.owner = owner
#         print(f'House owned by {self.owner}')
#
# myHouse = House()
...
# for row in range(n):
#     for col in range(n):
#         # print(f"Row number {row} - Col number {col}")
#         print('*',end=" ")
#     print()
