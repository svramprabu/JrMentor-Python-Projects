...
# Completed Python Sessions program to segragate students into section based on age
...
# Completed Python Sessions program to play Rock Paper Scissors
...
# my_dict = {'name':'Completed Python Sessions'}
# print(my_dict['name'])
# print(my_dict['names'])
